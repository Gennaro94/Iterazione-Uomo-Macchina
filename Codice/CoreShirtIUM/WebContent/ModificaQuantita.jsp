    ...
    <script>
       $(document).ready(function() {
    	   ...
    	   $("#pagina").click(function(){
    		   $("#info").text("Ti trovi nella pagina in cui modificare la quantita' degli articoli ");
    		   $("#popup").show();
      			$("#veil").fadeIn();
    	   })
		});
...
<div id="form">
<img  src="Immagini/Modifica.png">MODIFICA QUANTITA 
<BR></BR>
...
<form name="AggiungiPezzi" action="ServletTShirt" method="post">
   ...
   <div>Seleziona Taglia</div>
	...
	<div>Quantità</div>
    <input type="text" name="insertQuantita"/><img src="./Immagini/Info.jpg" id="iqu"><br>
