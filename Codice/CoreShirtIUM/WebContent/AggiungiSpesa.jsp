    ...
    <script>
       $(document).ready(function() {
    	   ...
    	   $("#pagina").click(function(){
    		   $("#info").text("Ti trovi nella pagina in cui inserire le spese");
    		   $("#popup").show();
      			$("#veil").fadeIn();
    	   })
		});
...
<div id="prezzo"><form name="InsertSpesa" action="ServletInsertSpesa" method="post">
  ...
  <input id="Prezzo" type="text" name="prezzo"><img src="./Immagini/Info.jpg" id="iprezzo"><br></div>
   Inserisci una breve descrizione
   <textarea name="descrizione"></textarea>
     <img src="./Immagini/Info.jpg" id="idesc">
