    ...
    <script>
       $(document).ready(function() {
    	   ...
    	   $("#isesso").click(function(){
    		   $("#info").text("Qui vengono visualizzati gli ordini in attesa di essere Evasi");
    		   $("#popup").show();
      			$("#veil").fadeIn();
    	   })
    	   $("#pagina").click(function(){
    		   $("#info").text("In questa pagina puoi effetuare operazione di ordini  ");
    		   $("#popup").show();
      			$("#veil").fadeIn();
    	   })
       });
...
<div id="sezione2">Evadi Ordine </div>
