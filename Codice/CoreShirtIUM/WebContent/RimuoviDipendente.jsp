...
<head>
	...
	<script>
       $(document).ready(function() {
    	   ...
    	   $("#irimuovi").click(function(){
    		   $("#info").text("seleziona il dipendente da rimuovere");
    		   $("#popup").show();
      			$("#veil").fadeIn();
    	   })
    	   $("#pagina").click(function(){
    		   $("#info").text("Ti trovi nella pagina in cui rimuovere i dipendenti");
    		   $("#popup").show();
      			$("#veil").fadeIn();
    	   })
		});
...
<form  action="GestisciDipendente" method="post" >
    ...
    <%
       Iterator<?> it1=d.iterator();
         ...
         <%}%>
	</select><img src="./Immagini/Info.jpg" id="irimuovi"> <br>
