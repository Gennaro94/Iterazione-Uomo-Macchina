...
<head>
    ...
    <link rel="stylesheet" href="./CSS/baseDipendenti.css" type="text/css">
	...
	<script>
       $(document).ready(function() {
    	   ...
    	   $("#idipendente").click(function(){
    		   $("#info").text("Seleziona il dipendente di cui modificare lo stipendio");
    		   $("#popup").show();
      			$("#veil").fadeIn();
    	   })
    	   $("#istip").click(function(){
    		   $("#info").text("Inserire lo stipendio");
    		   $("#popup").show();
      			$("#veil").fadeIn();
    	   })
    	   $("#pagina").click(function(){
    		   $("#info").text("Ti trovi nella pagina in cui modificare gli stipendi dei dipendenti");
    		   $("#popup").show();
      			$("#veil").fadeIn();
    	   })
		});
...
<form name="ModificaStipendio" action="GestisciDipendente" method="post">
	...
	<%
       Iterator<?> it1=d.iterator();
         ...
         <%}%>
     </select><img src="./Immagini/Info.jpg" id="idipendente"><br>
	Inserire lo stipendio
	<input id="stipendio" type="text" name="stipendio"><img src="./Immagini/Info.jpg" id="istip"><br>
