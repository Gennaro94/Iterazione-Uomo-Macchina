	...
	<script>
       $(document).ready(function() {
    	   ...
    	   $("#pagina").click(function(){
    		   $("#info").text("Ti trovi nella pagina in cui richiedere il rifornimento di prodotti");
    		   $("#popup").show();
      			$("#veil").fadeIn();
    	   })
		});
...
<form name="InsertRifornimento" action="ServletRifornimento" method="post">
	...
	<select id="insertarticolo" name="insertarticolo">
       ...
       Iterator<?> it1=articoli.iterator();
         ...
         <%}%>
   </select><img src="./Immagini/Info.jpg" id="icode"><br>
   <div>Seleziona Sesso</div>
	<select id="sesso" name="sesso">
	           <option value="M">Uomo</option>
		       <option value="F">Donna</option>
	</select><img src="./Immagini/Info.jpg" id="isesso"><br>
   ...
   <div>Quantità</div>
	...
	<img src="./Immagini/Info.jpg" id="iqu"><br>
<script>
function myFunction() {
...
<div id="lista"><h4 id="Sc">Prodotti da rifornire</h1>
<div id="dettagli"><h4 id="Sc">Codice, sesso, taglia, colore, quantità</h4>
