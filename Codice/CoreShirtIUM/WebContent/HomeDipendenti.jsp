    ...
    <script>
	   ...
	   $("#chiudi").click(function(){
		  ...
		  $("#pagina").click(function(){
   		   $("#info").text("Ti trovi nella Home Amministratore");
   		   $("#popup").show();
     			$("#veil").fadeIn();
...
<img src="./Immagini/InfoPagine.jpg" id="pagina" style="margin-left:-1220px; margin-bottom:-50px;">
    ...
    <div id="all">
        <div id="containerB">
    <div id="containerB1">
    <img  src="Immagini/Dipendente.png"><div id="aggiungi">Aggiungi Dipendente</div>
    <img  src="Immagini/DipendenteN.png"><div id="rimuovi">Rimuovi Dipendente</div>
    </div>
    <div id="containerB2">
    <img  src="Immagini/ModificaDip..png"><div id="modifica">Modifica Stipendio</div>
    <img  src="Immagini/FlussoDip.png"><div id="visualizza">Visualizza Flusso economico</div>
    </div>
    </div>
    </div>
