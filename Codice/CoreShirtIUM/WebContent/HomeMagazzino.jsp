   ...
   <link rel="stylesheet" href="./CSS/PopUp.css" type="text/css">
    ...
    <script>
		  ...
		  $("#pagina").click(function(){
   		   $("#info").text("Ti trovi nella Home Magazzino");
   		   $("#popup").show();
     			$("#veil").fadeIn();
...
<div id="wrapper">
    ...
    <div id="containerB">
        <div id="containerB1">
	    <img  src="Immagini/New.png">    <div id="inserisci">Inserisci Prodotti </div>
		 <img  src="Immagini/NewN.png">   <div id="rimuovi">Rimuovi Prodotti</div>
	    </div>
	    <div id="evadi">
	    <img  src="Immagini/Evadi.png">	<div>Evadi Ordini</div>
	    </div>
	    <div id="containerB2">
		   <img  src="Immagini/Modifica.png"> <div id="modifica">Modifica Quantità Prodotti</div>  
		   <img  src="Immagini/ModificaN.png"> <div id="rifornimento">Rifornimento Prodotti</div>
	    </div>
    </div>
