...
<head>
	...
	<script>
       $(document).ready(function() {
    	   ...
    	   $("#irichiesta").click(function(){
    		   $("#info").text("seleziona la richiesta da evadere");
    		   $("#popup").show();
      			$("#veil").fadeIn();
    	   })
    	   $("#pagina").click(function(){
    		   $("#info").text("Ti trovi nella pagina in cui ordinare prodotti o accettare richieste di rifornimento");
    		   $("#popup").show();
      			$("#veil").fadeIn();
    	   })
		});
...
<div id="rifornimento">
   <form id="rifornimento2" action="ServletRifornimento" method="post">
      ...
      <img src="./Immagini/Info.jpg" id="irichiesta"><br>
...
<form name="InsertProdotto" action="ServletInsertArticolo" enctype="multipart/form-data" method="post">
   ...
   Seleziona Sesso
   			...
   			<img src="./Immagini/Info.jpg" id="isesso"> 
   			<br/>
     Inserisci Quantita
	<input id="Quantita" type="number" name="insertQuantita"><img src="./Immagini/Info.jpg" id="iqu"><br>
